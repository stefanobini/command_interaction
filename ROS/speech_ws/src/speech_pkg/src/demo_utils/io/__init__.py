...
class AudioSource:
    '''Class defining the interface of a AudioSource object.

    The methods to implement are:
    
    - **\_\_init\_\_(self)**: constructor that takes as input the source settings (sr, frame_len , ...)
    - **get_audio_frame(self)**: returns a numpy audio frame 
    - **stop(self)**: this function close open streams
