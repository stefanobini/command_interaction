...
class HotwordDetector(object):
    ...
    def start_with_source(self, source, detected_callback=play_audio_file,
        ...
        """
        Start the voice detector. Like start but with custom source.
        """
        ...
        self.stream_in = self.audio.open(audio_callback)
