...
settings.experimentation:str = "MSI_exp0"
...
'''Dataset'''
settings.dataset.folder = "./datasets/MSI_exp0"
...
settings.logger.name:str = os.path.join(settings.experimentation, settings.input.language)                                                                             # name of the experiment
additional_info = ""
