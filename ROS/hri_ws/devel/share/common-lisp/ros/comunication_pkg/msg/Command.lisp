...
(cl:defmethod cl:initialize-instance :after ((m <Command>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Command)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name comunication_pkg-msg:<Command> is deprecated: use comunication_pkg-msg:Command instead.")))

(cl:ensure-generic-function 'label-val :lambda-list '(m))
(cl:defmethod label-val ((m <Command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comunication_pkg-msg:label-val is deprecated.  Use comunication_pkg-msg:label instead.")
  (label m))

(cl:ensure-generic-function 'english-val :lambda-list '(m))
(cl:defmethod english-val ((m <Command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comunication_pkg-msg:english-val is deprecated.  Use comunication_pkg-msg:english instead.")
  (english m))

(cl:ensure-generic-function 'italian-val :lambda-list '(m))
(cl:defmethod italian-val ((m <Command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comunication_pkg-msg:italian-val is deprecated.  Use comunication_pkg-msg:italian instead.")
  (italian m))
