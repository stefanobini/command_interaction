...
(cl:defmethod cl:initialize-instance :after ((m <Speech>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Speech)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name comunication_pkg-msg:<Speech> is deprecated: use comunication_pkg-msg:Speech instead.")))
