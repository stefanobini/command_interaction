...
(cl:defclass <Gesture> (roslisp-msg-protocol:ros-message)
  ((id
   ...
   (command
    :reader command
    :initarg :command
    :type gesture_pkg-msg:Command
    :initform (cl:make-instance 'gesture_pkg-msg:Command))
   (confidence
    :reader confidence
    :initarg :confidence
    :type cl:float
...
(cl:defmethod cl:initialize-instance :after ((m <Gesture>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Gesture)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gesture_pkg-msg:<Gesture> is deprecated: use gesture_pkg-msg:Gesture instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <Gesture>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gesture_pkg-msg:id-val is deprecated.  Use gesture_pkg-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'type-val :lambda-list '(m))
(cl:defmethod type-val ((m <Gesture>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gesture_pkg-msg:type-val is deprecated.  Use gesture_pkg-msg:type instead.")
  (type m))

(cl:ensure-generic-function 'timestamp-val :lambda-list '(m))
(cl:defmethod timestamp-val ((m <Gesture>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gesture_pkg-msg:timestamp-val is deprecated.  Use gesture_pkg-msg:timestamp instead.")
  (timestamp m))

(cl:ensure-generic-function 'command-val :lambda-list '(m))
(cl:defmethod command-val ((m <Gesture>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gesture_pkg-msg:command-val is deprecated.  Use gesture_pkg-msg:command instead.")
  (command m))

(cl:ensure-generic-function 'confidence-val :lambda-list '(m))
(cl:defmethod confidence-val ((m <Gesture>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gesture_pkg-msg:confidence-val is deprecated.  Use gesture_pkg-msg:confidence instead.")
  (confidence m))
