...
class wrenchWithCoeffArray {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.wrench_array.forEach((val) => {
      bufferOffset = wrenchStampedWithCoeff.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new wrenchWithCoeffArray(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.wrench_array[i] = wrenchStampedWithCoeff.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.wrench_array.forEach((val) => {
      length += wrenchStampedWithCoeff.getMessageSize(val);
    });
    return length + 4;
  }
  ...
  static datatype() {
    ...
    return 'iri_object_transportation_msgs/wrenchWithCoeffArray';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '7ae070e6b909e88cd2009fda3a6faf85';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new wrenchWithCoeffArray(null);
    ...
    if (msg.wrench_array !== undefined) {
      ...
      for (let i = 0; i < resolved.wrench_array.length; ++i) {
        resolved.wrench_array[i] = wrenchStampedWithCoeff.Resolve(msg.wrench_array[i]);
      }
    }
    else {
...
module.exports = wrenchWithCoeffArray;
