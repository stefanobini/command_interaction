...
class SpeechManagerRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SpeechManagerRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SpeechManagerRequest
    let len;
    let data = new SpeechManagerRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SpeechManagerRequest(null);
...
class SpeechManagerResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SpeechManagerResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SpeechManagerResponse
    let len;
    let data = new SpeechManagerResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'speech_pkg/SpeechManagerResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SpeechManagerResponse(null);
