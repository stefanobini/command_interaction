...
"""autogenerated by genpy from speech_pkg/SCRRequest.msg. Do not edit."""
import codecs
import sys
...
class SCRRequest(genpy.Message):
  _md5sum = "21e1815396969a6f82c0ae7d856b83d3"
  _type = "speech_pkg/SCRRequest"
...
float64 end_time"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SCRRequest, self).__init__(*args, **kwds)
...
def _get_struct_h2d():
    ...
    return _struct_h2d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from speech_pkg/SCRResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class SCRResponse(genpy.Message):
  _md5sum = "b530570166a9025ca374b3a6285b3928"
  _type = "speech_pkg/SCRResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """int8 cmd
float32[] probs
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SCRResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.cmd is None:
        self.cmd = 0
...
def _get_struct_b():
    ...
    return _struct_b
class SCR(object):
  _type          = 'speech_pkg/SCR'
  _md5sum = '896849feb7849138871db12c46e37d25'
  _request_class  = SCRRequest
  _response_class = SCRResponse
