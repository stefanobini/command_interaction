...
"""autogenerated by genpy from speech_pkg/Gesture.msg. Do not edit."""
import codecs
import sys
...
string italian"""
  ...
  _slot_types = ['string','string','string','speech_pkg/Command','float32']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.command is None:
        self.command = speech_pkg.msg.Command()
