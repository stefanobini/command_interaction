...
(cl:defmethod cl:initialize-instance :after ((m <twistStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'twistStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name iri_object_transportation_msgs-msg:<twistStamped> is deprecated: use iri_object_transportation_msgs-msg:twistStamped instead.")))
...
(cl:defmethod twist-val ((m <twistStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iri_object_transportation_msgs-msg:twist-val is deprecated.  Use iri_object_transportation_msgs-msg:twist instead.")
  (twist m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<twistStamped>)))
  ...
  "iri_object_transportation_msgs/twistStamped")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'twistStamped)))
  "Returns string type for a message object of type 'twistStamped"
  "iri_object_transportation_msgs/twistStamped")
