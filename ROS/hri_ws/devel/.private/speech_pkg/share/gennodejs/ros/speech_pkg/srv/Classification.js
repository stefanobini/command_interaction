...
class ClassificationRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ClassificationRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ClassificationRequest
    let len;
    let data = new ClassificationRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ClassificationRequest(null);
...
class ClassificationResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ClassificationResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ClassificationResponse
    let len;
    let data = new ClassificationResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'speech_pkg/ClassificationResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ClassificationResponse(null);
...
module.exports = {
  ...
  datatype() { return 'speech_pkg/Classification'; }
};
