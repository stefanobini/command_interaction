...
class IntentActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = IntentResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new IntentActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = IntentResult.Resolve(msg.result)
    }
    else {
      resolved.result = new IntentResult()
    }
...
module.exports = IntentActionResult;
