...
class IntentActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = IntentGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new IntentActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = IntentGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new IntentGoal()
    }
...
module.exports = IntentActionGoal;
