...
class IntentActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new IntentFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = IntentFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new IntentActionFeedback(null);
    ...
    data.feedback = IntentFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new IntentActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = IntentFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new IntentFeedback()
    }
...
module.exports = IntentActionFeedback;
