...
"""autogenerated by genpy from speech_pkg/IntentActionResult.msg. Do not edit."""
import codecs
import sys
...
class IntentActionResult(genpy.Message):
  _md5sum = "bec7c8a7d141c7aec21f78a19299b20b"
  _type = "speech_pkg/IntentActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','speech_pkg/IntentResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(IntentActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = speech_pkg.msg.IntentResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = speech_pkg.msg.IntentResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2iI().pack(_x.result.time_elapsed.secs, _x.result.time_elapsed.nsecs, _x.result.updates_n))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.time_elapsed.secs, _x.result.time_elapsed.nsecs, _x.result.updates_n,) = _get_struct_2iI().unpack(str[start:end])
      return self
