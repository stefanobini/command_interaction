...
"""autogenerated by genpy from speech_pkg/IntentActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class IntentActionFeedback(genpy.Message):
  _md5sum = "7d180ca849d0f3ec156099fd160a1ec1"
  _type = "speech_pkg/IntentActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','speech_pkg/IntentFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(IntentActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = speech_pkg.msg.IntentFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = speech_pkg.msg.IntentFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2i().pack(_x.feedback.time_elapsed.secs, _x.feedback.time_elapsed.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.time_elapsed.secs, _x.feedback.time_elapsed.nsecs,) = _get_struct_2i().unpack(str[start:end])
      return self
