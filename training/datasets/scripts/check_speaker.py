...
ANNOTATION_FILE_1 = "./datasets/MTL_experimentation_0/training/annotations/eng/training.csv"
ANNOTATION_FILE_2 = "./datasets/MTL_experimentation_0/validation/annotations/eng/validation_snr40.csv"
