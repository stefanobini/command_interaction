...
settings.tasks:List[str] = ["speaker"]                                   # [["command"], ["speaker"], ["command", "speaker"], ["intent", "explicit", "implicit"]]
info = ""
...
'''Model'''
settings.model.network:str = "resnet8"                                      # ["resnet8", "mobilenetv2", "conformer", "HS", "SS", "HS_msi"]
