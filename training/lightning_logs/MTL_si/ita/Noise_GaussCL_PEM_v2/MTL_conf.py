...
settings.dataset.speech.testing.annotations:str = os.path.join(settings.dataset.folder, "testing", "annotations", settings.input.language, "validation.csv")
...
'''Logger'''
settings.logger.version:str = "trial_0"
