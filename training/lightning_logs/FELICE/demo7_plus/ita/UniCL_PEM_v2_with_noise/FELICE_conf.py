...
settings.dataset.speech.validation.annotations:str = os.path.join(settings.dataset.folder, "validation", "annotations", settings.input.language, "validation_snr20-40.csv")
...
settings.noise.min_snr:int = 20                                              # [-10, 0]
