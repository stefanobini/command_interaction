...
settings.model.conformer.use_group_norm: bool = True
...
settings.training.batch_size:int = 8                                      # at least 104 for 'ita' and 80 for 'eng' to have in the batch all 31 commands in each batch
