...
'''Dataset'''
settings.dataset.folder = "./datasets/MTL_experimentation_0"
...
settings.dataset.speech.validation.annotations:str = os.path.join(settings.dataset.folder, "validation", "annotations", settings.input.language, "validation_snr40.csv")
...
'''Model'''
settings.model.network:str = "multitask_scr_si"                                      # ["resnet8", "mobilenetv2", "conformer", "multitask_scr_si"]
...
settings.logger.name:str = os.path.join("MTL", settings.input.language)                                                                             # name of the experiment
network = "HS_"
additional_info = ""
settings.logger.version:str = "{}{}{}".format(network, settings.noise.curriculum_learning.distribution, additional_info)
