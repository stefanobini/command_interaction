...
'''Dataset'''
settings.dataset.folder = "./datasets/MTL_scr_sid"
...
settings.training.loss.grad_norm.alpha:float = 0.15                         # Default = 0.12. For task with different level of complexity ah higher value of alpha should be used to enforce the stronger training rate balancing
...
additional_info = "_grad_norm_alfa_0o15"
