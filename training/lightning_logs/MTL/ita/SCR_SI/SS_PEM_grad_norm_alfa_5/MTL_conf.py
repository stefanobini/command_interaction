...
settings.training.loss.grad_norm.alpha:float = 5                         # Default = 0.12. For task with different level of complexity ah higher value of alpha should be used to enforce the stronger training rate balancing
