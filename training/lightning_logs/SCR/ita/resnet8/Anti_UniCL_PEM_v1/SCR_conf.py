...
settings.noise.curriculum_learning.distribution:str = "Anti_UniCL_PEM_v1"                 # Between ["PEM", "UniCL_PEM_v1", "Anti_UniCL_PEM_v1", "UniCL_PEM_v2", "Anti_UniCL_PEM_v2", "GaussCL_PEM_v1", "Anti_GaussCL_PEM_v1", "GaussCL_PEM_v2", "Anti_GaussCL_PEM_v2"]
