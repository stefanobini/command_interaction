...
settings.input.spectrogram.win_lenght:int = int(settings.input.spectrogram.win_sec * settings.input.sample_rate)
settings.input.spectrogram.hop_lenght:int = settings.input.spectrogram.win_lenght // 2
...
settings.noise.curriculum_learning.distribution:str = "uniform"     # Between ["uniform", "dynamic_uniform", "dynamic_gaussian"]
