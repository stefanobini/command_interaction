...
settings.experimentation:str = "MSIexp1"
settings.task:str = "MSI"
settings.tasks:List[str] = ["intent", "explicit", "implicit"]                                                       # [["command"], ["speaker"], ["command", "speaker"], ["intent", "explicit", "implicit"]]
info = ""
...
'''Dataset'''
settings.dataset.folder = os.path.join("datasets", "MSIexp1")
settings.dataset.annotations = os.path.join("datasets", "MSIexp1")
settings.dataset.speech.training.annotations:str = os.path.join(settings.dataset.annotations, "training", "annotations", settings.input.language, "training.csv")
settings.dataset.speech.validation.annotations:str = os.path.join(settings.dataset.annotations, "validation", "annotations", settings.input.language, "validation.csv")
...
settings.dataset.noise.training.annotations:str = os.path.join(settings.dataset.annotations, "annotations", "noise", "training.csv")
