...
class PL_MTL_Backbone(pl.LightningModule):
    ...
    def __init__(self, settings:DotMap, task_n_labels:List[int], task_loss_weights:np.float32=None):
        ...
        self.set_model_parameters(task_n_labels=task_n_labels)
        self.set_training_parameters(task_loss_weights=task_loss_weights)
        self.initialize_results_list()
        self.set_results_path()
        self.save_hyperparameters()


    def set_model_parameters(self, task_n_labels:List[int]):
