...
APPROACH_2 = "HS_equal_weights"         # ["resnet8", "HS_equal_weights", "SS_equal_weights", "HS_fixed_weights", "SS_fixed_weights", "HS_grad_norm", "SS_grad_norm"]
