...
from callbacks import start, restart_conversation, receive, get_gender, get_age, conv_pause, select_query, get_lang, reset, get_country, \
...
def main():
    ...
    states[COUNTRY_STATE] = [CallbackQueryHandler(get_country)]
